...
public abstract class ResearchableDataRegistryBuilder<R, I extends BitInfoResearchable<R>> extends DataRegistryBuilder<R, I> {
    public ResearchableDataRegistryBuilder(BitRegistry<R, I> registry, int priority) {
        super(registry, priority);
    }
    public ResearchableDataRegistryBuilder(BitRegistry<R, I> registry) {
        super(registry);
    }
