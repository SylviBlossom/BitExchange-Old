...
public class BitRegistries {
    ...
    public static final BitRegistry<Fluid, FluidBitInfo> FLUID;

    static {
        ITEM = Registry.register(REGISTRY, new Identifier(BitExchange.MOD_ID, "item"), new ItemBitRegistry(Registry.ITEM));
        FLUID = Registry.register(REGISTRY, new Identifier(BitExchange.MOD_ID, "fluid"), BitRegistry.of(FluidBitInfo.class, Registry.FLUID));
    }
